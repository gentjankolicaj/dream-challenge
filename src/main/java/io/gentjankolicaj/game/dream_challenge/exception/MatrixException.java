package io.gentjankolicaj.game.dream_challenge.exception;
...
public class MatrixException extends RuntimeException {
    ...
    public String getMessage() {
        ...
        message = message + " Choice matrix dim : [" + userChoices.length + "," + userChoices[0].length + "]";
        message = message + " Rand matrix dim : [" + randomChoices.length + "," + randomChoices[0].length + "]";
        return message;
    }
}
